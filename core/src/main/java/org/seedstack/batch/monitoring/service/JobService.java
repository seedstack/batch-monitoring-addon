...
public interface JobService {
	 ...
	 *             the no such job execution exception
	 * @throws JobExecutionAlreadyRunningException
	 *             the job execution already running exception
	 * @throws JobRestartException
	 *             the job restart exception
	 ...
	 *             the job execution not running exception
	 */
	 ...
	 * 
	 * @param start
	 *            the start index of the job names to return
	 * @param count
	 *            the maximum number of job names to return
	 ...
	 * 
	 * @return the total number of jobs {@link #listJobs(int, int)}.
	 */
	int countJobs();
	 ...
	 *             the no such job instance exception
	 */
	 ...
	 *            the name of the job
	 * @param start
	 *            the index of the first to return
	 * @param count
	 ...
	 *             the no such job exception
	 */
	Collection<JobInstance> listJobInstances(String jobName, int start,
	 ...
	 *            the job name
	 * @param start
	 *            the start index of the first job execution
	 * @param count
	 ...
	 *             the no such job exception
	 */
	Collection<JobExecution> listJobExecutionsForJob(String jobName, int start,
			int count) throws NoSuchJobException;
	 ...
	 * 
	 * @param start
	 *            the index of the first execution to return
	 * @param count
	 ...
	 *            with wildcards)
	 * @param stepName
	 *            the step name (or a pattern with wildcards)
	 * @param start
	 *            the start index of the first execution
	 * @param count
	 *            the maximum number of executions to return
	 * @return a collection of {@link StepExecution}
	 * @throws NoSuchStepException
	 *             the no such step exception
	 */
	 ...
	 * 
	 * @param jobName
	 *            the job name (or a pattern with wildcards)
	 * @param stepName
	 *            the step name (or a pattern with wildcards)
	 * @return the number of executions
	 * @throws NoSuchStepException
	 ...
	 *             the no such step execution exception
	 * @throws NoSuchJobExecutionException
	 *             the no such job execution exception {@link JobExecution}.
	 */
	 ...
	 * @param jobName
	 *            the name of the job
	 * @return the step names for job
	 * @throws NoSuchJobException
	 *             if the job name cannot be located
	 */
