...
public interface SearchableStepExecutionDao extends StepExecutionDao {
	 ...
	 */
	Collection<StepExecution> findStepExecutions(String jobName,
	 ...
	 * @param stepName
	 *            the step name pattern.
	 * 
	 * @return the total number of step executions in the repository matching
	 *         the pattern
	 */
