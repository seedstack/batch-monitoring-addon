...
(function(window, $) {
    ...
    angular.module('ngGrid').run(['$templateCache', function($templateCache) {
        ...
        $templateCache.put('footerTemplate.html',
                ...
                "\n" +
                "            <input class=\"ngPagerCurrent\" min=\"1\" max=\"{{currentMaxPages}}\" type=\"number\" style=\"width:50px; height: 24px; margin-top: 1px; padding: 0 4px; line-height: normal;\" ng-model=\"pagingOptions.currentPage\"/>\r" +
                "\n" +
